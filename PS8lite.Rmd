...
Note that `caret::train` was used to find optimal `mtry`, which turned out to be 19. Process was commented out because it takes a bit of time to run/knit.

```{r}
#following code references random_forests.Rmd by Albert Kim for SDS293

# #perform cross-validation to find best mtry with `caret
...
```{r}
#fit RF using the optimal mtry=19 found under cross-validation
